...
{
    public sealed class AddPropertyModelToClassModel : CodeActivity
    {
        [RequiredArgument]
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            var pModel = new PropertyModel(PropertyName.Get(context), PropertyTypeName.Get(context), RequiresInitialization.Get(context), MarkRequiredInBuilder.Get(context));
